          ...
          children: [
            ...
            Expanded(
              child: Container(
                  ...
                  child:Column(
                      children: [
                        Container(color: Colors.blueAccent,child: Center(child: Text("Sales History",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: Colors.white,)))),
                        ...
                        Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text("Customer_Id",style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold,color: Colors.grey,)),
                                VerticalDivider(color: Colors.black,thickness: 1,),
                        ...
                        Container(decoration: BoxDecoration(color: Colors.greenAccent,borderRadius: BorderRadius.circular(5)),width: double.infinity,padding: EdgeInsets.all(8),margin: EdgeInsets.all(8),child: Center(child:  Obx(()=>Text("Total Sales: ${pC.total}",style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold,color: Colors.black,))))),
                      ])),
            )
          ],
        ),
