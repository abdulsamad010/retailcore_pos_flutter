...
class NewSalesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: CustomAppBar(name: "New Sale"),
        ...
        body:
        Obx(()=> pC.products.isNotEmpty ? ListView.builder(itemCount: pC.products.length,itemBuilder:(context,index){
            if(i<5)
            {
              i++;
            }
                ...
                children: [
                  ...
                  Column(
                    children: [
                      ...
                      Obx(()=>Text("${pC.screenQuantityDisplay[index]}",style: TextStyle(fontSize: 10,fontWeight: FontWeight.bold,color: Colors.black,))),
